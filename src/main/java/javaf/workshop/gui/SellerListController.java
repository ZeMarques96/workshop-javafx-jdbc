...
public class SellerListController implements Initializable, DataChangerListener {
    ...
    public void onBtNewAction(ActionEvent event) {
        ...
        createDialogForm(obj, "/javaf/workshop/SellerForm.fxml", parentStage);
    }
            ...
            protected void updateItem(Seller obj, boolean empty) {
                ...
                button.setOnAction(
                        event -> createDialogForm(
                                obj, "/javaf/workshop/SellerForm.fxml", Utils.currentStage(event)));
            }
        });
    }
